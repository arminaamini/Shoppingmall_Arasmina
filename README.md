...
Java Advanced Project – Layered Architecture (MVC + Service + Repository)
# Project Overview

This project is a desktop-based Shopping Mall system developed in Java.
It simulates a real-world shopping environment where users can log in as Customer or Administrator, manage products, handle shopping carts, and complete purchases.

The main focus of this project is not only functionality, but also clean architecture, separation of concerns, and maintainable design.
